...
// MFC_LR.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCLRApp, CWinApp)
...
// Единственный объект CMFCLRApp

CMFCLRApp theApp;


// Инициализация CMFCLRApp

BOOL CMFCLRApp::InitInstance()
{
